...
export function DeletePropertyModal({
  ...
  return (
    <>
      ...
      />
      <div className="fixed inset-x-4 top-10 max-w-md mx-auto bg-white z-50 rounded-2xl shadow-estate-lg border border-estate-border overflow-hidden animate-fade-up">
