...
import { HomeIcon, UsersIcon, UserIcon, ClipboardDocumentListIcon, CalendarIcon, ChartBarIcon, StarIcon } from "@heroicons/react/24/outline";
...
export default function AdminSidebar() {
  ...
  return (
    <>
      <aside className="hidden lg:flex flex-col w-64 bg-gradient-to-b from-estate-navy to-estate-blue bg-opacity-90 backdrop-blur-lg p-4 text-white flex-shrink-0">
