...
import { HomeIcon, UsersIcon, CogIcon, ClipboardDocumentListIcon, CalendarIcon, ChartBarIcon } from "@heroicons/react/24/outline";
    ...
    <aside className="hidden lg:flex flex-col w-64 bg-gradient-to-b from-estate-navy to-estate-blue bg-opacity-90 backdrop-blur-lg p-4 text-white">
      ...
      <nav className="flex-1 space-y-2">
        {navItems.map((item) => {
          ...
          return (
            <Link key={item.href} href={item.href} className="flex items-center p-2 rounded hover:bg-white hover:bg-opacity-10 transition">
