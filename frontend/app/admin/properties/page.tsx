                      ...
                      <div className="flex flex-wrap justify-end gap-2">
                        {property.approvalStatus !== 'Approved' && (
                          <button
                            ...
                            className="px-3 py-1.5 min-h-[36px] bg-emerald-50 text-emerald-700 border border-emerald-200 hover:bg-emerald-100 rounded-lg text-xs font-semibold transition disabled:opacity-50"
                          >
                        ...
                        {property.approvalStatus !== 'Rejected' && (
                          <button
                            ...
                            disabled={actionLoading === `approve-${property.id}` || actionLoading === `reject-${property.id}`}
                            className="px-3 py-1.5 min-h-[36px] bg-rose-50 text-rose-700 border border-rose-200 hover:bg-rose-100 rounded-lg text-xs font-semibold transition disabled:opacity-50"
                          >
